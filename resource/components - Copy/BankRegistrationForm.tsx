              ...
              <motion.div key="form">
                ...
                <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <motion.div variants={fieldVariants}>
                    ...
                    <div className="flex items-center gap-2 rounded-md border-none bg-cyan-400/6 px-3 py-2.5 shadow-xl
                ...
                <motion.div variants={fieldVariants} className="mt-4">
                  ...
                  <div className="flex items-center gap-2 rounded-md border-none bg-cyan-400/6 shadow-xl
