...
// ---- Overview Tab (now includes stats grid) --------------------------------

function OverviewTab({ recentUsers, stats }: { recentUsers: RecentUser[], stats: DashboardStats | null }) {
  return (
