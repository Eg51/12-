...
// export default function LuminaLogin() {
...
//   const marketData = [
//     { label: "MARKET STATUS", value: "OPEN", status: "active" },
//     { label: "LLM", value: "+1.24%", status: "up" },
//     { label: "BTC", value: "+0.82%", status: "up" },
//   ];
...
//           {/* Right Column - Market Status & Features */}
//           <motion.div
//             variants={cardVariants}
//             className="space-y-4"
//           >
...
//   );
// }
// app/login/page.tsx (updated section)
...
export default function Loge() {
  ...
  const [marketData, setMarketData] = useState<MarketStatus[]>([
    ...
    { label: "LLM", value: "---", status: "neutral" },
  ...
  const fetchMarketData = async () => {
    ...
    try {
      ...
      // Using CoinGecko API for crypto data and a fallback for stocks
      ...
      // Determine if market is open (9:30 AM - 4:00 PM EST, Monday-Friday)
      ...
      // Use fallback data with realistic values
      const isMarketOpen = checkMarketHours();
      setMarketData([
        {
          label: "MARKET STATUS",
  ...
  const checkMarketHours = (): boolean => {
    ...
    // Market is open Monday-Friday (day 1-5)
    if (day === 0 || day === 6) return false;

    // Market hours: 9:30 AM - 4:00 PM EST
    // Convert to local time (assuming EST offset is -5)
