        ...
        {showInvestModal && selectedAsset && (
          ...
          >
            ...
            >
              ...
              <div className={`rounded-xl p-4 mb-4 bg-bg-[#C4F8FD] shadow-xl ${selectedAsset.bgGradient} border-none`}>
                <div className="flex items-center justify-between">
                  <div>
              ...
              <div className="space-y-3">
                <div>
                  <label className="text-xs font-bold text-slate-400 block mb-1">Amount(USD)</label>
                  <input
                    type="number"
                    placeholder="0.00"
                    value={investmentAmount}
                    onChange={(e) => setInvestmentAmount(e.target.value)}
                    className="w-full rounded-lg border-none shadow-xl bg-[#C4F8FD] px-4 font-bold py-3 text-emerald-400 placeholder:text-slate-500
                ...
                <div className="flex gap-2 flex-wrap">
                  {[100, 500, 1000, 5000].map((amount) => (
                    <button
                      key={amount}
                      onClick={() => setInvestmentAmount(amount.toString())}
                      className="flex-1 min-w-[60px] rounded-lg bg-[#C4F8FD] px-3 py-1.5 text-xs font-medium text-amber-400 hover:bg-slate-700
                       transition-colors border-none shadow-xl hover:border-slate-600"
                    >
                      {amount}
                    </button>
                  ))}
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={handleConfirmInvestment}
                  className="w-full rounded-xl bg-[#C4F8FD]0 py-3 font-bold text-emerald-400 shadow-xl
                   hover:from-cyan-400 hover:to-blue-500 transition-all cursor-pointer"
                >
                  <span className="flex items-center justify-center gap-2">
                    <Send size={18} />
                    Confirm
...
export default function Dash() {
  ...
  // New states for Add Funds and Refresh
  const [showAddFundsModal, setShowAddFundsModal] = useState(false);
  const [isRefreshing, setIsRefreshing] = useState(false);
  const [refreshMessage, setRefreshMessage] = useState('');

  // Hardcoded account details (admin can update these later via API)
  const accountDetails = {
    bankName: "AshTrust Bank",
    accountNumber: "1234567890",
    sortCode: "12-34-56",
    accountName: "AshTrust PLC",
    reference: "Your Username + Date"
  };
    ...
    <div className="min-h-screen bg-[#C4F8FD] to-gray-300 p-4 sm:p-6 lg:p-8">
      ...
      >
        ...
        <motion.div
          ...
          variants={cardVariants}
          whileHover={{ scale: 1.02, boxShadow: "0 20px 50px rgba(0,0,0,0.1)" }}
          className="mb-6 rounded-2xl bg-gradient-to-br from-[#C4F8FD] via-[#B0F0F8] to-[#9AE8F2] p-6 shadow-xl
          hover:shadow-2xl transition-all duration-300 border-none"
        >
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              <p className="text-sm font-medium text-cyan-700">
          ...
          <div className="flex items-center gap-4 mt-2 flex-wrap">
            <motion.button
              ...
              className="flex items-center gap-1 rounded-lg bg-white/30 px-3 py-1.5 text-xs font-medium text-cyan-700
              shadow-md hover:shadow-lg transition-all hover:bg-white/50 disabled:opacity-50"
            >
              <RefreshCw size={14} className={isRefreshing ? 'animate-spin' : ''} />
              {isRefreshing ? 'Refreshing...' : 'Refresh'}
            </motion.button>
            {refreshMessage && (
              <span className="text-xs text-emerald-600">{refreshMessage}</span>
            )}
              <div className="pl-[70%]">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    ...
                    className="flex items-center gap-1 rounded-lg bg-[#C4F8FD] px-3 py-1.5 text-xs
                    text-amber-400 font-bold shadow-xl cursor-pointer hover:shadow-2xl transition-all duration-300 hover:bg-[#b0ecf5]"
                  >
                  <Plus className='text-amber-400 font-bold' size={14} />
                  <span className='py-1 px-2'>Add</span>
                </motion.button>
              </div>
            </div>
          </motion.div>
        <div className="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-1">
          <motion.div
            ...
            whileTap={{ scale: 0.99 }}
            variants={cardVariants}
            className="rounded-2xl border-none shadow-xl bg-gradient-to-br from-[#C4F8FD] via-[#B5F0F8] to-[#A5E8F2] p-5
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <motion.div
            ...
            whileTap={{ scale: 0.98 }}
            variants={cardVariants}
            className="rounded-2xl border-none bg-gradient-to-br from-[#C4F8FD] via-[#B0F0F8] to-[#9AE8F2]
             shadow-xl p-5 backdrop-blur-xl hover:shadow-2xl transition-all duration-300"
          >
            {/* --- MODIFIED: Added "Add" button next to "Assets" --- */}
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-semibold text-slate-600">Assets</h2>
              <div className="flex items-center gap-2">
                <Link href={'/Buy'}>
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.02, boxShadow: "0 20px 50px rgba(0,0,0,0.08)" }}
            whileTap={{ scale: 0.98 }}
            className="rounded-2xl border-none shadow-xl bg-gradient-to-br from-[#C4F8FD] via-[#B5F0F8] to-[#A5E8F2]
            p-5 backdrop-blur-sm hover:shadow-2xl transition-all duration-300"
          >
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-semibold text-slate-600">Upcoming Bills</h2>
              <Link href={"/Bills"}>
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.01, boxShadow: "0 20px 50px rgba(0,0,0,0.06)" }}
          whileTap={{ scale: 0.99 }}
          className="mt-4 rounded-2xl border-none bg-gradient-to-br from-[#C4F8FD] via-[#B0F0F8] to-[#9AE8F2]
          shadow-xl p-5 hover:shadow-2xl transition-all duration-300"
        >
          <div className="flex items-center text-cyan-700 justify-between">
            <h2 className="text-sm font-semibold text-slate-600">Recent Bills</h2>
          </div>
        ...
        {showAddFundsModal && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 20 }}
              className="w-full max-w-md rounded-2xl bg-none p-6 shadow-xl border-none"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-bold text-amber-400">Add Funds</h2>
                <button
                  onClick={() => setShowAddFundsModal(false)}
                  className="rounded-lg p-1 hover:bg-white/10 transition-colors"
                >
                  <div className="font-lg text-cyan-900">✕</div>
                </button>
              </div>

              <div className="space-y-5 gap-4">
                <div className="rounded-xl bg-[#C4F8FD] p-4 border-none shadow-xl">
                  <div className="mt-3 space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-cyan-600 font-bold">Bank:</span>
                      <span className="text-cyan-600 font-bold">{accountDetails.bankName}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-cyan-600 font-bold">Account Number:</span>
                      <span className="text-cyan-600 font-bold">{accountDetails.accountNumber}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-cyan-600 font-bold">Account Name:</span>
                      <span className="text-cyan-600 font-bold">{accountDetails.accountName}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-cyan-600 font-bold">Reference:</span>
                      <span className="text-cyan-600 font-bold">{accountDetails.reference}</span>
                    </div>
                  </div>
                </div>
                ...
                <motion.button
                  ...
                  onClick={() => {
                    ...
                    alert('Please make the payment using the above details.');
                  }}
                  className="w-full rounded-xl bg-[#C4F8FD] py-3 font-bold text-cyan-900
                   shadow-xl hover:text-slate-300 hover:bg-cyan-600 transition-all"
                >
                  Confirm & Proceed
                </motion.button>
              </div>
